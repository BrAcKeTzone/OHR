					...
					<form method = "POST" enctype = "multipart/form-data">
						<div class = "form-group">
							...
							<select class = "form-control" required = required name = "room_type">
								...
								<option value = "Economy" <?php if($fetch['room_type'] == "Economy"){echo "selected";}?>>Economy</option>
								<option value = "Deluxe" <?php if($fetch['room_type'] == "Deluxe"){echo "selected";}?>>Deluxe</option>
								<option value = "Suite" <?php if($fetch['room_type'] == "Suite"){echo "selected";}?>>Suite</option>
							</select>
						</div>
						<div class = "form-group">
							<label>Price </label>
