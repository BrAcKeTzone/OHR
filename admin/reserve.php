...
<body>
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><strong><?php if($fetch['checkin'] <= date("Y-m-d", strtotime("+8 HOURS"))){echo "<label style = 'color:#ff0000;'>".date("M d, Y", strtotime($fetch['checkin']))."</label>";}else{echo "<label style = 'color:red;'>".date("M d, Y", strtotime($fetch['checkin']))."</label>";}?></strong></td>
	...
	<div style = "text-align:right; margin-right:10px;" class = "navbar navbar-default navbar-fixed-bottom">
		<label>&copy; Copyright Group 1 2022 </label>
	</div>
</body>
